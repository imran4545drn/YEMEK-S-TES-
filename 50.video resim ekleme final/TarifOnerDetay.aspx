...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <asp:Panel ID="Panel1" runat="server">
        <table class="auto-style7">
            ...
            <tr>
                <td style="font-weight: 700" class="auto-style9">Kategori:</td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" style="font-weight: 700" Text="ONAYLA" Width="150px" />
                </td>
            </tr>
        </table>
    </asp:Panel>
